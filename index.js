...
function filterUnfundedOnly() {
    ...
    console.log("The amount of unfunded games is: ", unfundedGames.length);
...
function filterFundedOnly() {
    ...
    console.log("The amount of funded games is: ", fundedGames.length);
...
const unfundedGamesString = `There ${unfundedGamesCount === 1 ? "is" : "are"} ${unfundedGamesCount.toLocaleString()} unfunded game${unfundedGamesCount === 1 ? "" : "s"} on our platform.`;
...
runnerUpGameElement.innerHTML = `Runner Up Game: ${runnerUpGame.name}`;
